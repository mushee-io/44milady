...
pub struct Liquidate<'info> {
    ...
    pub credit_account: Box<Account<'info, CreditAccount>>,
    #[account(
        mut,
    ...
    pub usdg_mint: Box<InterfaceAccount<'info, Mint>>,
    #[account(
        mut,
    ...
    pub liquidator_usdg_account: Box<InterfaceAccount<'info, TokenAccount>>,
    #[account(
        mut,
        token::mint = usdg_mint,
